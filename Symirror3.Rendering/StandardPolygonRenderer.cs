...
namespace Symirror3.Rendering
{
    internal class StandardPolygonRenderer : PolygonRenderer
    {
        ...
        private static Quaternion FromTo(Vector3 from, Vector3 to)
        {
            ...
            if (Vector3Operator.ApproximatelyEqual(axis, Vector3.Zero, 1f / 256f))
                return Quaternion.Identity;
            return Quaternion.CreateFromAxisAngle(Vector3.Normalize(axis), -MathF.Acos(Vector3.Dot(to, from)));
        }
    }
}
